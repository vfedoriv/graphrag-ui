...
This specification defines the required behavior for previewing, creating, monitoring, and retrying chunk-strategy migration plans in the GraphRAG admin UI.
