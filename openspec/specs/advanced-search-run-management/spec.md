...
This specification defines readiness, submission, lifecycle, history, and result handoff behavior for durable advanced-search runs in the GraphRAG admin UI.
