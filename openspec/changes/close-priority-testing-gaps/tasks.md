...
- [x] 3.3 Add Schema Builder tests for schema load, validation, create, and update failure feedback plus guarded actions without a selected knowledge base; verify visible alerts and absence of invalid mutation calls.
