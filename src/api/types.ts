...
export type AdvancedSearchAttemptDiagnostics = { roundNumber: number; subqueryId: string | null; retriever: string; status: string; candidateCount: number; latencyMs: number; failureCategory: string | null }
