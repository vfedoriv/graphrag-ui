...
const diagnostics = z.object({
  ...
  attempts: z.array(z.object({ roundNumber: z.number().int(), subqueryId: nullableString, retriever: z.string(), status: z.string(), candidateCount: z.number().int(), latencyMs: z.number(), failureCategory: nullableString }).strict()),
