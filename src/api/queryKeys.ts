export const queryKeys = {
  ...
  reprocessingPlanHistory: (knowledgeBaseId: string, draftId: string, page: number, size: number) => ['reprocessing-plans', knowledgeBaseId, draftId, 'history', page, size] as const,
