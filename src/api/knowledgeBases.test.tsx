...
describe('knowledge bases api', () => {
  ...
  it('calls CRUD endpoints', async () => {
    const fetchMock = stubFetch((url) => {
      ...
      if (url.endsWith('/knowledge-bases/kb-a')) return jsonResponse(200, { id: 'kb-a', name: 'KB A', activeSchemaId: null, createdAt: '' })
      return jsonResponse(200, { id: 'kb-a', name: 'KB A', activeSchemaId: null, createdAt: '' })
    })
