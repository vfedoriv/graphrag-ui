...
export function QueriesPage() {
  ...
  const topSection = (
    <div className='stack'>
      ...
      />
      <p>Use tabs below to run endpoint workflows for query generation, validation, execution, and one-shot ask.</p>
      <RuntimeContextSummary
        knowledgeBaseId={selectedKnowledgeBaseId}
        settingHints={['query', 'safety']}
  ...
  const orderedTabs = [tabs[0], tabs[1], tabs[2], tabs[3]].filter(Boolean)
  ...
  return (
    <ControllerPage
      ...
      tabsDescription='Ask, generate Cypher, validate Cypher, and execute Cypher remain separate request flows.'
